...
template <typename type>
bool Vector<type>::CheckIndex(int index)
{
...
template <typename type>
void Vector<type>::Set(int index, type e)
{
    if (CheckIndex(index))
    {
        if (!itemsFlag)
...
template <typename type>
bool Vector<type>::Contains(type e)
{
...
template <typename type>
void Vector<type>::Insert(int index, type e)
{
    if (IsFull())
    {
...
template <typename type>
type Vector<type>::Delete(int index)
{
    if (!IsEmpty())
    {
        if (CheckIndex(index))
